...
class CategoryForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $cod->addValidation("Código", new TRequiredValidator()); 
        ...
        $row2 = $this->form->addFields([new TLabel("Código:", '#ff0000', '14px', null)],[]);
        $row3 = $this->form->addFields([new TLabel("Assunto:", '#ff0000', '14px', null)],[$subject_id],[new TLabel("Código:", '#ff0000', '14px', null)],[$cod]);
        $row3->layout = [' col-sm-2 control-label',' col-sm-6',' col-sm-2',' col-sm-2'];

        $row4 = $this->form->addFields([new TLabel("Descrição:", '#ff0000', '14px', null)],[$description]);
        ...
        $row6 = $this->form->addFields([$tab_643d77dd51843]);
