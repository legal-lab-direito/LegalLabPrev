        ...
        if (single_field.length || array_field.length || multifile_field) {
            ...
            if (Adianti.formEventsCounter == 0 ) {
                if(multifile_field.length) {
                    ...
                    if (single_field.attr('widget') == 'thtmleditor') {
                    ...
                    else if (single_field.attr('widget') == 'bsignaturedrawcapture') {
                        bsignaturedrawcapture_set_value(single_field.attr('id'), value);
                    }
                        ...
                        if (single_field.val() !== value) {
                            ...
                            if(single_field.hasClass('tcombo_disabled'))
                            {
...
function tgantt_set_day_action(id, day_action)
{
    ...
    $(id + ' .tgantt-cell').on('click', function(){
        ...
        __adianti_load_page( day_action+'&start_time='+$(this).data('date')+'&group_id='+tr_data['id']);
    })
}