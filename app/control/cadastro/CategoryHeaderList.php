...
class CategoryHeaderList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_Category';
    ...
    public function __construct($param = null)
    {
        ...
        $action_onDelete = new TDataGridAction(array('CategoryHeaderList', 'onDelete'));
        ...
        $button_cadastrar->setAction(new TAction(['CategoryForm', 'onShow']), "Cadastrar");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['CategoryHeaderList', 'onExportCsv'],['static' => 1]), self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['CategoryHeaderList', 'onExportXls'],['static' => 1]), self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['CategoryHeaderList', 'onExportPdf'],['static' => 1]), self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['CategoryHeaderList', 'onExportXml'],['static' => 1]), self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Cadastro","Categorias"]));
        }
