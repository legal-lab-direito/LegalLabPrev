...
RUN apt-get -y install php8.1-dev php8.1-xml php8.1-intl build-essential libaio1 php-odbc php8.1-cli php8.1-common php8.1-mysql php8.1-zip php8.1-gd php8.1-mbstring php8.1-curl php8.1-xml php8.1-bcmath
RUN apt-get -y install php8.1-mbstring php8.1-yaml php8.1-mcrypt php8.1-pgsql php8.1-uploadprogress php8.1-memcache php8.1-phpdbg php8.1-uuid php8.1-memcached php8.1-soap php8.1-xdebug php8.1-ssh2  php8.1-xmlrpc php8.1-xsl
ENV ACCEPT_EULA=Y
